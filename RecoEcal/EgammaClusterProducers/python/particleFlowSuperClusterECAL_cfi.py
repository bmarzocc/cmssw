...
particleFlowSuperClusterECALMustache = cms.EDProducer(
    ...
    # verbosity 
    verbose = cms.untracked.bool(False),
    #clustering type: "Box" or "Mustache" or "DeepSC"
...
particleFlowSuperClusterECALDeepSC = cms.EDProducer(
    ...
    # window width in ECAL ( these don't mean anything for Mustache or DeepSC )
    phiwidth_SuperClusterBarrel = cms.double(0.6),
    etawidth_SuperClusterBarrel = cms.double(0.04),
...
particleFlowSuperClusterECAL = particleFlowSuperClusterECALDeepSC.clone()
